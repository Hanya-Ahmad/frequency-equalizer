...
Options = controls_column.selectbox(
    'Mode', ('Audio', 'Music', 'Letters', 'Arrhythmia'))
spectrogram_checkbox = controls_column.checkbox('Spectrogram')
# ----------------------------------------   Common functions
if Options == 'Arrhythmia':
    resulting_df, loaded_sound_file, ifft_file, time = ar.arrhythmia(
    ...
    if Audio:
        ...
        if Options == 'Letters':
            ...
            modified_amplitude, empty = lt.letters_modification(rfrequency, amplitude, Audio_sliders_data, main_column, controls_column)
        # --------------------- Sound Processing
